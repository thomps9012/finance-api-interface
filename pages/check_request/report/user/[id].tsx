...
import {
  CheckDetail,
  UserCheckRequests,
} from "../../../../types/checkrequests";
import Link from "next/link";
import jwtDecode from "jwt-decode";
import {
  ALL_USERS,
  GET_USER_CHECK_REQUESTS,
...
export const getServerSideProps = async ({
  ...
  return {
    props: {
      base_report: jwt != undefined ? response.data.user_check_requests : null,
      user_list: jwt != undefined ? users.data.all_users : null,
